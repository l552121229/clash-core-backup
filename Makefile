...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/l552121229/clash-core-backup/constant.Version=$(VERSION)" \
		-X "github.com/l552121229/clash-core-backup/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
